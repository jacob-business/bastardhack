...
def Traits():
    classdic={}
    classdic["Witch"]= "You made a pact with a Demon. +1 Magic Die, Demon Pact Spell, Curse."
    classdic["Cleric"]= "You joined a Religion. +1 Faith Die, Divine Spell."
    classdic["Cultist"]= "You joined a Cult. +1 Faith Die, Occult Spell."
    classdic["Wizard"]= "You studied at a Wizard College. +1 Magic Die, Spell."
    classdic["Warlock"]= "You studied a forbidden magic. +1 Magic Die, Spell, Curse."
    classdic["Druid"]= "You were raised in the wilderness. +1 Magic Die, Shapeshifting."
    classdic["Wanderer"]= "You met a companion on your long travels. Companion, Map, Ranged Weapon?"
    classdic["Fighter"]= "You learned how to fight. +1 Attack, Weapon-skill."
    classdic["Knight"]= "You were born or made a Knight. +1 HP, costs 12g/month to keep your status. Armor. Long Sword. Shield or Lantern."
    classdic["Barbarian"]= "You learned to fight with fury. +1 Attack, Melee Weapon, Rage."
    classdic["Rogue"]= "You learned some tricks from thieves."
    classdic["Assassin"]= "You killed someone. +1 Attack."
    CLASSTRAIT=classdic[STARTINGCLASS]
    return CLASSTRAIT
